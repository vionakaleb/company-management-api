...
CREATE TABLE company (id serial PRIMARY KEY, name varchar(255) NOT NULL, address varchar(255) NOT NULL, revenue bigint NOT NULL, phone_code bigint NOT NULL, phone_number bigint NOT NULL);
